...
class HashtagEntity extends Entity {
  ...
  factory HashtagEntity.fromRawJson(String str) => HashtagEntity.fromJson(json.decode(str));

  factory HashtagEntity.fromJson(Map<String, dynamic> json) => new HashtagEntity(
