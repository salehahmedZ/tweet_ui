          ...
          child = AspectRatio(
            child: GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 2,
                childAspectRatio: widget.viewMode == ViewMode.standard ? MediaContainer.SQUARE_ASPECT_RATIO : MediaContainer.DEFAULT_ASPECT_RATIO_MEDIA_CONTAINER,
            ...
            aspectRatio: widget.viewMode == ViewMode.standard ? MediaContainer.SQUARE_ASPECT_RATIO : MediaContainer.DEFAULT_ASPECT_RATIO_MEDIA_CONTAINER,
          );
          break;
        default:
